<x-modal data-modal-backdrop="static" id="delete{{ $book->id }}">
  <x-modal-header data-modal-toggle="delete{{ $book->id }}">Confirm Delete</x-modal-header>
  <div class="p-4 md:p-5 text-center">
    ...
    {{-- DELETE FORM --}}
    <form action="{{ route('daftarbuku.destroy', $book->id) }}" method="POST">
      @csrf
      @method('DELETE')
